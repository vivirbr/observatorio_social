...
mun_br <- read.csv("/home/vivrbr/Documents/consult_stuff/diversa_2023/data/deforestation/mapbiomas_alerts_mun.csv") %>% select(CD_MUN)
...
write.csv(full_radarsit,"/home/vivrbr/Documents/consult_stuff/diversa_2023/data/full_radarsit.csv",row.names=FALSE)
